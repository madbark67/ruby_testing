...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the previous step gives 16' do
      it 'returns 12' do
        last_step = 16

        result = game.subtract_four(last_step)
  ...
  describe '#divide_by_two' do
    context 'when the previous value is 8' do
      it 'returns four' do
        last_step = 8

        result = game.divide_by_two(last_step)
  ...
  describe '#subtract_random_number' do
    context 'when random_number is 5 and previous is 10' do
      subject(:game) { MagicSeven.new(5) }
      it 'returns 5' do
        previous = 10

        result = game.subtract_random_number(previous)
  ...
  describe '#play' do
    ...
    context 'when the random number is 45' do
      subject(:game) { MagicSeven.new(45) }
      # remove the 'x' before running this test
      it 'will return 7' do
        expect(game.play).to eq(7)
      end
