...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 5 and max is 9' do
      subject(:game_guessing) { described_class.new(5, 9, number_guessing).make_guess }

      it 'returns 7' do
        expect(game_guessing).to eq(7)
      end
    end
  ...
  describe '#game_over?' do
    let(:number_guessing) { double('number_guessing', { value: 7 }) }
    ...
    context 'when guess and random_number are equal' do
      ...
      subject(:game_guessing) { described_class.new(5, 9, number_guessing, 7) }
    ...
    context 'when guess and random_number are not equal' do
      subject(:game_continue) { described_class.new(5, 9, number_guessing, 8) }
  ...
  describe '#update_range' do
    ...
    context 'when the guess is 7, min=5, and max=8' do
      ...
      it 'updates min to the same value as max' do
        expect(same_guess_game.min).to eq(8)
      end
